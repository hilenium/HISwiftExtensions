...
//                
//                let date1 = NSDate()
//                let date2 = Calendar.current.date(byAdding: .day, value: -1, toDate: NSDate())
//                
...
//                
//                let date2 = Calendar.current.date(byAdding: .second, value: -1, toDate: NSDate())
//                
...
//                
//                let date2 = Calendar.current.date(byAdding: .minute, value: -1, toDate: NSDate())
//                
...
//                
//                let date2 = Calendar.current.date(byAdding: .minute, value: -5, toDate: NSDate())
//                
...
//                
//                let date2 = Calendar.current.date(byAdding: .hour, value: -1, toDate: NSDate())
//                
...
//                
//                let date2 = Calendar.current.date(byAdding: .day, value: -2, toDate: NSDate())
//                
...
//                
//                let date2 = Calendar.current.date(byAdding: .month, value: -1, toDate: NSDate())
//                
...
//            it("time ago - 1 month ago (numeric)") {
//                
//                let date2 = NSCalendar.current.date(byAdding: .year, value: -1, toDate: NSDate())
//                
